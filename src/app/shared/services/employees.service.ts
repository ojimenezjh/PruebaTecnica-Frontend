...
export class EmployeesService {
  ...
  public getEmployees() {
    return {
      data:
        this.httpClient.get(this.appInfo.apiUrl + '/employees/find', { headers: this.requestHeader, observe: 'response' })
          .pipe(
  ...
  public getEmployeesByDepartment(department: string) {
    return {
      data:
        this.httpClient.get(this.appInfo.apiUrl + `/employees/findDepartment/${department}`, { headers: this.requestHeader, observe: 'response' })
          .pipe(
            catchError(this.handleError)
          ),
    };
